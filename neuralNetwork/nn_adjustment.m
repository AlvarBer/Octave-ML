...
function [bestNodes,adjError] = nn_adjustNodes(X_tra,Y_tra,X_adj,Y_adj, ...
                                               num_inputs,lambda,hiddenNodes)
   ...
   for i= 1:columns(hiddenNodes)
      ...
      params_nn = [Theta1(:); Theta2(:)];
      [Theta1, Theta2, costs(i)] = nn_training (X_tra,Y_tra,num_inputs, ...
                                                hiddenNodes(i),1,lambda, ...
                                                params_nn,max_iterations);
      params_nn = [Theta1(:); Theta2(:)];
   ...
   G_nn_adjustNodes(errTraining, errAdjustment,hiddenNodes); % Print the graphics
